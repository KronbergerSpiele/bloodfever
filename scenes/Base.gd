...
var Global setget , Global_get
var Page setget , Page_get
export(AudioStream) var backgroundMusic = null
func Global_get():
  return self.get_node("/root/GlobalManager")
func Page_get():
  return self.get_node("CanvasLayer/Page")
...
func _process(_delta: float):
  if self.ticks < 2:
    ...
    if ((typeof(self.Global.lastScene) != typeof(self)) or ((typeof(self.Global.lastScene) == typeof(self)) and (self.Global.lastScene != self))):
